"""
Django settings for muddy_lake_45356 project.
...
ROOT_URLCONF = 'muddy_lake_45356.urls'
...
WSGI_APPLICATION = 'muddy_lake_45356.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_lake_45356 API",
    "DESCRIPTION": "API documentation for muddy_lake_45356 App",
    "VERSION": "v1",
}
